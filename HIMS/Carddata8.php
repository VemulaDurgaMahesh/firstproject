...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "number"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "fnam"+selectedRow;
          ...
          var serviceMemberLocation = "lna"+selectedRow;
          ...
          var serviceTypeLocation = "agen"+selectedRow;  
          ...
          var serviceGenderLocation = "male"+selectedRow;  
