...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "no"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "fname"+selectedRow;
          ...
          var serviceMemberLocation = "lnam"+selectedRow;
          ...
          var serviceTypeLocation = "yrs"+selectedRow;  
          ...
          var serviceGenderLocation = "ctgr"+selectedRow;  
