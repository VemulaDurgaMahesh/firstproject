...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "umrno"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "memname"+selectedRow;
          ...
          var serviceMemberLocation = "membname"+selectedRow;
          ...
          var serviceTypeLocation = "ageyear"+selectedRow;  
          ...
          var serviceGenderLocation = "gender"+selectedRow;  
