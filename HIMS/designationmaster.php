...
<ul class="drop_menu">
		...
		<p class="agreement">
			...
			echo "<input type='text' name='wc' value=DESG".$count." style='width:185px; height:23px;' readonly='readonly' required>";
?>
...
$str="insert into designation_master values('".$val1."','".$val2."',true,'".$_SESSION['username']."','".date('Y-m-d h:m:s',$t)."',NULL,NULL,true)";
