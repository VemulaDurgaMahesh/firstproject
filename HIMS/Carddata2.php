...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "umr"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "mem"+selectedRow;
          ...
          var serviceMemberLocation = "memb"+selectedRow;
          ...
          var serviceTypeLocation = "ageyr"+selectedRow;  
          ...
          var serviceGenderLocation = "gndr"+selectedRow;  
