...
$str=mysql_query("SELECT * from department_master WHERE dept_name like '%".$_POST['t1']."%'");
}
else
{
	$str=mysql_query("SELECT * from department_master");
}
echo "<table border='1' class='act'>";
	...
	<td><?php  echo $row['dept_createby'] ?></td>
	<td><?php  echo $row['dept_createdate'] ?></td>
...
echo "<table border='1' class='act'>";
	...
	<td align='center'>Department Code</td>
	...
	<td align='center'><?php  echo $row['dept_status'] ?></td>
	</tr>
<?php
}
echo "</table>";
