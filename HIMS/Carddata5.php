...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "urno"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "mename"+selectedRow;
          ...
          var serviceMemberLocation = "mebame"+selectedRow;
          ...
          var serviceTypeLocation = "ageyar"+selectedRow;  
          ...
          var serviceGenderLocation = "gendr"+selectedRow;  
