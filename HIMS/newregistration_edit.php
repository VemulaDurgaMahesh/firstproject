...
<?php include("menu.php");?>
	...
	<div class="image">
			...
			<a href="occ.php" onclick="positionedPopup(this.href,'myWindow','700','300','100','200','yes');return false"><img src="search.png"></a>
			</fieldset>
			</p>
			<p>
			<fieldset>
			...
			<select name="qstnry">
			 <option value="1">By word of Mouth</option> 
			  <option value="2">Refered by Friends</option> 
