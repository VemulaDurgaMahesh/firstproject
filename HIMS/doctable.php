...
<ul class="drop_menu">
              ...
              <a href="doctable_search.php">
                ...
                <li>
                 <a> <button name="export_excel" formaction="doctable_excel.php" >Export</button></a>
                  </li>
                  <li>
...
$str="SELECT * from doctor WHERE doc_createdate between '$appdate' and '$appdate1'";
...
echo "</table>";
  ...
  {
    ?>
        <script>alert('No data Found');window.location.href='doctable.php';</script>
        <?php
  }
