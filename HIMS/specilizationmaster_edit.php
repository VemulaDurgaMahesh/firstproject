...
$str="UPDATE specilization_master SET spl_name='".$val2."', spl_status='".$val4."',spl_modifyby='".$_SESSION['username']."', spl_modifydate='".date('Y-m-d h:m:s',$t)."' WHERE spl_code='".$val1."'";
if ($conn->query($str) == TRUE) {
    ?>
	<script>
	window.alert('Sucessfully Updated');
	window.location.href='specializationtable.php';
	</script>
	<?php
}
else
