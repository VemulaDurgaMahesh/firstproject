...
<ul class="drop_menu">
              ...
              <a href="area_search.php">
                ...
                <li>                
              <a> <button name="export_excel" formaction="area_excel.php" >Export</button></a>
              </li> 
              <li>
...
$str="SELECT * from area_master WHERE area_createddate between '$appdate' and '$appdate1'";
