...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
             ...
             var serviceNameLocation = "cit"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceNa";
            ...
            var serviceNameLocation = "city"+selectedRow;
           var txtName = window.opener.document.getElementById(serviceNameLocation);
           var serviceNameSelector = "#row"+rowID+" .sourceServiceNam";
            txtName.value = $(serviceNameSelector).val();

            var serviceCodeLocation = "pincode"+selectedRow;
...
<form name="form1" action="" method="post" autocomplete="off">
                                    ...
                                    {                    
                                    $srch=$_POST['srch'];             
                        $query="SELECT * from city_master Where city_status=1 and city_name like '%".$_POST['srch']."%' ";
                                    }
                                    else
                                    {
                                        $query="SELECT * from city_master Where city_status=1 ";
                                    }
                                        ...
                                        <table class="table table-condensed table-hover">
                                            ...
                                            <?php
                                                    ...
                                                    $ds=mysql_query("SELECT * FROM district_master WHERE district_code='$distcode'");
                                                    ...
                                                    $pincode=$row['city_pin'];
                                                    $pid=$sn1["state_name"];
                                                    $pno=$cn1["country_name"];
                                                    $dist=$ds1['district_name'];
                                    
                                                ?>
                                                    <tr class="clickable" id="row<?php echo $i;?>" onclick="SetName('<?php echo $i;?>');" >
                                                        <td> <?php echo $i ?></td>   
                                                        <td><input type="text" name="num" class="sourceServiceNa" readonly value="<?php echo $row['city_code'];?>" ></td>         
                                                         <td><input type="text" name="num" class="sourceServiceNam" readonly value="<?php echo $cityname;?>" ></td>
                                                        <td><input type="text" name="num1" class="sourceServiceCod" readonly value="<?php echo $pincode;?>" ></td>                                    
