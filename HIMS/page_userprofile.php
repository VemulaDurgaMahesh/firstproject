...
if(isset($_POST['t1']))
{
$str=mysql_query("SELECT * from profile WHERE profile_name like '%".$_POST['t1']."%' ORDER BY profile_code ASC ");
}
else
{
	$str=mysql_query("SELECT * from profile ORDER BY profile_code ASC ");
}
echo "<table border='1'>";
	echo "<tr>
	<td>S.no</td>
	...
	<td><?php  echo $row['user_groupcode'] ?></td>	
