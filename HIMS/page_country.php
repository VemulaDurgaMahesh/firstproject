...
$str=mysql_query("SELECT * from country_master WHERE country_name like '%".$_POST['t1']."%'");
}
else
{
	$str=mysql_query("SELECT * from country_master");
}
...
echo "<table border='1' class='act'>";
	...
	<td align='center'><?php  echo $row['country_status'] ?></td>
	</tr>
<?php
}
echo "</table>";
