...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "umrnum"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "mbr"+selectedRow;
          ...
          var serviceMemberLocation = "mebr"+selectedRow;
          ...
          var serviceTypeLocation = "agyr"+selectedRow;  
          ...
          var serviceGenderLocation = "gdr"+selectedRow;  
