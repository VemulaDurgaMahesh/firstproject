...
<form action="vouchertable_search_view.php" method="GET">

<table border=1 class='act'>
	<tr><td>VOUCHER CODE</td><td>VOUCHE NAME</td><td>CREATED BY</td><td>CREATED DATE</td><td>MODIFIED BY</td><td>MODIFIED DATE</td><td>STATUS</td></tr>
