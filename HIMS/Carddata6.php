...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "umrn"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "memn"+selectedRow;
          ...
          var serviceMemberLocation = "lname"+selectedRow;
          ...
          var serviceTypeLocation = "age"+selectedRow;  
          ...
          var serviceGenderLocation = "type"+selectedRow;  
