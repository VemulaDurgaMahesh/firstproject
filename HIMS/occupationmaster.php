...
<ul class="drop_menu">
		...
		<p class="agreement">
			...
			echo "<input type='text' name='wc' value=OCC".$count." style='width:185px; height:23px;' readonly='readonly' required>";
?>
			</p><br>
			<p class="agreement">
...
$str="insert into occupation_master values('".$val1."','".$val2."','".$_SESSION['username']."','".date('Y-m-d h:m:s',$t)."',NULL,NULL,true,true)";
