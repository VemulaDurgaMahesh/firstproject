...
<ul class="drop_menu">
              ...
              <a href="emptable_search.php">
                ...
                <li>
                 <a> <button name="export_excel" formaction="emptable_excel.php" >Export</button></a>
                  </li>
            <li>
...
$str="SELECT * from employee WHERE emp_createdtime between '$appdate' and '$appdate1'";
...
<td><input type='text' name='t59' id='t59' value='".$row['emp_efname']."' readonly='readonly'></td>
...
<td><input type='text' name='t58' id='t58' value='".$row['emp_status']."' readonly='readonly'></td>
</td></form></tr>";
}
echo "</table>";
}
  ...
  {
    ?>
        <script>alert('No data Found');window.location.href='emptable.php';</script>
        <?php
  }
