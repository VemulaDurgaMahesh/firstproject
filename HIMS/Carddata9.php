...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "numbe"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "fna"+selectedRow;
          ...
          var serviceMemberLocation = "ln"+selectedRow;
          ...
          var serviceTypeLocation = "year"+selectedRow;  
          ...
          var serviceGenderLocation = "mal"+selectedRow;  
