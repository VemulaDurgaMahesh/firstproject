...
echo "<table border=1>";
	echo "<tr><td>S. NO. </td><td>BED CODE</td><td>BED STATUS</td><td>IS ACTIVE</td><td>ROOM CODE</td><td>WARD CODE</td><td>WARD NAME</td></form></tr>";
    while($row = $result->fetch_assoc()) {
		$room="ro".$cou;
		$sno="so".$cou;
	echo "<tr><td><input type='text' style='margin-left:0; border:none;' name='".$sno."' id='t7' value='".$row['ROOMS_SNO']."' readonly='readonly'></td><td><input type='text' style='margin-left:0; border:none;' name='".$room."' id='t1' value='".$row['ROOMS_BEDCODE']."' ></td><td><input type='text' style='margin-left:0; border:none;' name='t6' id='t6' value='".$row['ROOMS_BEDSTATUS']."' readonly='readonly'></td><td><input type='text' style='margin-left:0; border:none;' name='t2' id='t2' value='".$row['ROOMS_STATUS']."' readonly='readonly'></td><td><input name='t3' id='t3' style='margin-left:0; border:none;' value='".$row['ROOMS_CODE']."' readonly='readonly' ></td><td><input type='text' style='margin-left:0; border:none;' name='t4' id='t4' value='".$row['ROOMS_WARDCODE']."' readonly='readonly'></td><td><input type='text' style='margin-left:0; border:none;' name='t5' id='t5' value='".$row['ROOMS_WARDNAME']."' readonly='readonly'></td></td></tr>";
	$cou=$cou+1;
	$_SESSION['cou']=$cou;
}
echo "</table>";
