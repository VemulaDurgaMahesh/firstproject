...
<style type="text/css">
    ...
    function SetName(rowID) {
        if (window.opener != null && !window.opener.closed) {
            var serviceNameLocation = "umno"+selectedRow;
           ...
           var serviceNameSelector = "#row"+rowID+" .sourceServiceName";
            ...
            var serviceCodeLocation = "memna"+selectedRow;
          ...
          var serviceMemberLocation = "membna"+selectedRow;
          ...
          var serviceTypeLocation = "ageyer"+selectedRow;  
          ...
          var serviceGenderLocation = "gnder"+selectedRow;  
